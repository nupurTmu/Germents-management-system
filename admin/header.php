...
$select= "SELECT * FROM tbl_admin WHERE admin_name ='$admin_name' limit 1";
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                  <b style="color:white; margin-right:30px">Manager Name : <?php echo $_SESSION['admin_name'];?></b> <a class="btn btn-outline-danger btn-sm" href="logout.php">Logout</a>
                </li>
            </ul>
        </nav>
        <!-- header section End ```````````````````````````-->