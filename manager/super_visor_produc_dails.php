  ...
  <!--  -------------- Main content Start---------------------------------------->
       ...
       <div id="layoutSidenav_content">
                <main>
                    <?php 
                     $get = $_GET['sup_id'];
                     $_SESSION['get_supervisor'] = "$get";
                    ?>
                    <div class="container-fluid px-4">
                        <h4 class="mt-4">Supervisor Production Report </h4>
                        <div class="row ">
                          <div class="card">
                            <div class="card-body">
                               <div class="col-lg-12">
                                 <div class="row">
                                   <div class="col-lg-6">
                                     <form action="search_production.php" method="POST">
                                    <div class="row pb-3">
                                    <div class="col-md-5">
                               ...
                               <h5 class="text-center">Total Production:( 
                                <?php
                                   $get = $_GET['sup_id'];
                                    $selct_production = "SELECT SUM(qty) AS sum from tbl_production WHERE supervisor_id ='$get'";
                              ...
                              <?php 
                                  $selct_production=" SELECT * FROM `tbl_production` 
                                            ...
                                            INNER JOIN tbl_product ON tbl_production.product_id = tbl_product.product_id
                                              WHERE tbl_production.supervisor_id ='$get'"; 
                                   $run = mysqli_query($con,$selct_production);
                                   if($run){
                                      $count ="1";
                                   while($res = mysqli_fetch_array($run)){  ?>
