<?php
  ...
  $con = mysqli_connect('localhost','root','','management_system');
      ...
      $production_id =  $rows['production_id'];
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse ml-5" id="navbarSupportedContent">
                  <ul class="navbar-nav margin-nav  me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item ml-1">
                      <a class="nav-link" href="Add_Production.php">Add Production</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Worker_list.php">Worker List</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="Total_Production.php">Total Production</a>
                    </li>
